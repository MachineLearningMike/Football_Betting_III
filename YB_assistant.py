...
def get_train_and_new_from_football_data(gameHistoryFolderPath, countryThemeFolder, definitions, columns, country, skip=False):
        Non_Odds_cols = columns.Required_Non_Odds_cols
        num_bookies = country.NUMBER_BOOKIES
        oddsGroupsToExclude = country.BOOKIE_TO_EXCLUDE
        preferedOrder = country.PREFERED_ORDER
