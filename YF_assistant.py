...
def fixture_id_to_ids_uk_v3(folder, id_to_ids_filename, targetLength, df_total, df_search, year_span, testcount=-1):
        ...
        id_list_s = list(df_search['id']); div_list_s = list(df_search['Div']); home_list_s = list(df_search['HomeTeam']); away_list_s = list(df_search['AwayTeam']); date_list_s = list(df_search['Date'])
